...
public class MainMenu extends Activity implements OnClickListener  {
	...
	private EditText colInput, rowInput, mineInput;
	...
	public void onCreate(Bundle abby) {
		...
		colInput = (EditText) findViewById(R.id.colInput);
		rowInput = (EditText) findViewById(R.id.rowInput);
		mineInput = (EditText) findViewById(R.id.mineInput);
